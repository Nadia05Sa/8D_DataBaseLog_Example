...
SECRET_KEY = 'django-insecure-vu0879th!tfxg2tr2g+3@y@0q5*nm9zd6xk*v9p6o_g#+*8@cm'
...
MIDDLEWARE = [
    ...
    # CORS Middleware: Permite peticiones cross-origin desde el frontend React
    # Debe ir lo más arriba posible para procesar las cabeceras CORS correctamente
...
WSGI_APPLICATION = 'Servidor_Curso.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:5174", # Puerto por defecto de React
]